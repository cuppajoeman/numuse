...
# This is when you give the NCs directly
["(4 7 11 2) (9 0 4 7)", "(2 6 9 0)", "(7 11 2 6)"]

# This is without underlying structure
["(4 | 0 3 7 10) (9 | 0 3 7 10)", "(2 | 0 4 7 10)", "(7 | 0 4 7 11)"]

# This is when you have underlying structure
["<9 | 0 3 7 10> <2 | 0 3 7 10>", "<7 | 0 4 7 10>", "<0 | 0 4 7 11>"]

# without RIC
["<9 0 4 7> <2 5 9 0>", "<7 11 2 5>", "<0 4 7 11>"]

matches = re.findall(
    '\[[^\]]*\]|\([^\)]*\)|"[^"]*"|\<[^\>]*\>|\S+', "<9 0 4 7> <2 5 9 0> 2u"
)
